...
let video;
let isVolumeOn = true;
let videoPath = "./public/img/blade_100.mp4";
...
let sketch = (p) => {
  ...
  p.setup = () => {
    ...
    canvas.parent("p5-films");

    canvas.elt.setAttribute(
      "aria-label",
      "Edited video from the film Blade Runner 1982"
    );
    ...
    p.describe("Edited video from the film Blade Runner 1982");
  };
